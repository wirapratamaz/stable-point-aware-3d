...
class Unwrapper(nn.Module):
    ...
    def _handle_remaining_uvs(
        ...
        # Add a small padding
        uc = (
            uc * (1 - island_padding * num_square_width * 0.25)
            + island_padding * num_square_width * 0.125
        ).clip(0, 1)
        vc = (
            vc * (1 - island_padding * num_square_height * 0.25)
            + island_padding * num_square_height * 0.125
        ).clip(0, 1)
